...
public class Exercise4Test extends PetDomainForKata
{
    ...
    public void streamsToECRefactor2()
    {
        ...
        MutableBag<PetType> counts = this.people.flatCollect(Person::getPetTypes).toBag();
    ...
    public void streamsToECRefactor3()
    {
        ...
        MutableList<ObjectIntPair<PetType>> topFavourites =
                this.people.flatCollect(Person::getPetTypes).toBag().topOccurrences(3);
        Verify.assertSize(3, topFavourites);
        Verify.assertContains(PrimitiveTuples.pair(PetType.CAT, 2), topFavourites);
        Verify.assertContains(PrimitiveTuples.pair(PetType.DOG, 2), topFavourites);
        Verify.assertContains(PrimitiveTuples.pair(PetType.HAMSTER, 2), topFavourites);
